//************************************************************
// Desciption: PREv18 Register File Header File
...
typedef union prev18_r00{
  struct{
    unsigned MBUS_R0		: 24;
  };
  uint32_t as_int;
} prev18_r00_t;
#define PREv18_R00_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r00_t) == 4, "Punned Structure Size");

// Register 0x01 [AMBA:0xA0000004]
typedef union prev18_r01{
  struct{
    unsigned MBUS_R1		: 24;
  };
  uint32_t as_int;
} prev18_r01_t;
#define PREv18_R01_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r01_t) == 4, "Punned Structure Size");

// Register 0x02 [AMBA:0xA0000008]
typedef union prev18_r02{
  struct{
    unsigned MBUS_R2		: 24;
  };
  uint32_t as_int;
} prev18_r02_t;
#define PREv18_R02_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r02_t) == 4, "Punned Structure Size");

// Register 0x03 [AMBA:0xA000000C]
typedef union prev18_r03{
  struct{
    unsigned MBUS_R3		: 24;
  };
  uint32_t as_int;
} prev18_r03_t;
#define PREv18_R03_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r03_t) == 4, "Punned Structure Size");

// Register 0x04 [AMBA:0xA0000010]
typedef union prev18_r04{
  struct{
    unsigned MBUS_R4		: 24;
  };
  uint32_t as_int;
} prev18_r04_t;
#define PREv18_R04_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r04_t) == 4, "Punned Structure Size");

// Register 0x05 [AMBA:0xA0000014]
typedef union prev18_r05{
  struct{
    unsigned MBUS_R5		: 24;
  };
  uint32_t as_int;
} prev18_r05_t;
#define PREv18_R05_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r05_t) == 4, "Punned Structure Size");

// Register 0x06 [AMBA:0xA0000018]
typedef union prev18_r06{
  struct{
    unsigned MBUS_R6		: 24;
  };
  uint32_t as_int;
} prev18_r06_t;
#define PREv18_R06_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r06_t) == 4, "Punned Structure Size");

// Register 0x07 [AMBA:0xA000001C]
typedef union prev18_r07{
  struct{
    unsigned MBUS_R7		: 24;
  };
  uint32_t as_int;
} prev18_r07_t;
#define PREv18_R07_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r07_t) == 4, "Punned Structure Size");

// Register 0x08 [AMBA:0xA0000020]
typedef union prev18_r08{
  struct{
    unsigned GOCEP_CHIP_ID		: 16;
  };
  uint32_t as_int;
} prev18_r08_t;
#define PREv18_R08_DEFAULT {{0x0000}}
_Static_assert(sizeof(prev18_r08_t) == 4, "Punned Structure Size");

// Register 0x09 [AMBA:0xA0000024]
typedef union prev18_r09{
  struct{
...
#define PREv18_R09_DEFAULT {{0x80008, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(prev18_r09_t) == 4, "Punned Structure Size");

// Register 0x0A [AMBA:0xA0000028]
typedef union prev18_r0A{
  struct{
    unsigned FLAGS		: 24;
  };
  uint32_t as_int;
} prev18_r0A_t;
#define PREv18_R0A_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r0A_t) == 4, "Punned Structure Size");

// Register 0x0B [AMBA:0xA000002C]
typedef union prev18_r0B{
  struct{
    unsigned GOC_SEL		: 4;
...
#define PREv18_R0B_DEFAULT {{0x8, 0x0, 0x0, 0x7, 0x1, 0x0, 0x1, 0x2, 0x3, 0x0}}
_Static_assert(sizeof(prev18_r0B_t) == 4, "Punned Structure Size");
...
typedef union prev18_r0E{
  struct{
    unsigned GOCEP_TIMEOUT		: 24;
  };
  uint32_t as_int;
} prev18_r0E_t;
#define PREv18_R0E_DEFAULT {{0x1E8480}}
_Static_assert(sizeof(prev18_r0E_t) == 4, "Punned Structure Size");

// Register 0x0F [AMBA:0xA000003C]
typedef union prev18_r0F{
  struct{
...
#define PREv18_R0F_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(prev18_r0F_t) == 4, "Punned Structure Size");

// Register 0x10 [AMBA:0xA0000040]
typedef union prev18_r10{
  struct{
    unsigned RUN_CPU		: 1;
  };
  uint32_t as_int;
} prev18_r10_t;
#define PREv18_R10_DEFAULT {{0x0}}
_Static_assert(sizeof(prev18_r10_t) == 4, "Punned Structure Size");

// Register 0x11 [AMBA:0xA0000044]
typedef union prev18_r11{
  struct{
...
#define PREv18_R11_DEFAULT {{0x000000, 0x0, 0x0}}
_Static_assert(sizeof(prev18_r11_t) == 4, "Punned Structure Size");

// Register 0x12 [AMBA:0xA0000048]
// -- READ-ONLY --

// Register 0x13 [AMBA:0xA000004C]
typedef union prev18_r13{
  struct{
...
#define PREv18_R13_DEFAULT {{0x0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(prev18_r13_t) == 4, "Punned Structure Size");

// Register 0x14 [AMBA:0xA0000050]
typedef union prev18_r14{
  struct{
    unsigned XOT_CNT_SAT_UPPER		: 16;
  };
  uint32_t as_int;
} prev18_r14_t;
#define PREv18_R14_DEFAULT {{0x0000}}
_Static_assert(sizeof(prev18_r14_t) == 4, "Punned Structure Size");
...
typedef union prev18_r17{
  struct{
    unsigned CPS_ON		: 3;
  };
  uint32_t as_int;
} prev18_r17_t;
#define PREv18_R17_DEFAULT {{0x0}}
_Static_assert(sizeof(prev18_r17_t) == 4, "Punned Structure Size");

// Register 0x18 [AMBA:0xA0000060]
typedef union prev18_r18{
  struct{
...
#define PREv18_R18_DEFAULT {{0x00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(prev18_r18_t) == 4, "Punned Structure Size");

// Register 0x19 [AMBA:0xA0000064]
typedef union prev18_r19{
  struct{
...
#define PREv18_R19_DEFAULT {{0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7, 0x4, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1}}
_Static_assert(sizeof(prev18_r19_t) == 4, "Punned Structure Size");

// Register 0x1A [AMBA:0xA0000068]
typedef union prev18_r1A{
  struct{
    unsigned XO_CAP_TUNE		: 12;
  };
  uint32_t as_int;
} prev18_r1A_t;
#define PREv18_R1A_DEFAULT {{0x000}}
_Static_assert(sizeof(prev18_r1A_t) == 4, "Punned Structure Size");

// Register 0x1B [AMBA:0xA000006C]
typedef union prev18_r1B{
  struct{
...
#define PREv18_R1B_DEFAULT {{0x0, 0x0, 0x1, 0x1}}
_Static_assert(sizeof(prev18_r1B_t) == 4, "Punned Structure Size");

// Register 0x1C [AMBA:0xA0000070]
typedef union prev18_r1C{
  struct{
...
#define PREv18_R1C_DEFAULT {{0x0, 0x2, 0x2, 0x00}}
_Static_assert(sizeof(prev18_r1C_t) == 4, "Punned Structure Size");
...
typedef union prev18_r1F{
  struct{
    unsigned MBUS_WATCHDOG_THRESHOLD		: 24;
  };
  uint32_t as_int;
} prev18_r1F_t;
#define PREv18_R1F_DEFAULT {{0x16E360}}
_Static_assert(sizeof(prev18_r1F_t) == 4, "Punned Structure Size");
...
#define PREv18_R29_DEFAULT {{0x0000, 0x00}}
_Static_assert(sizeof(prev18_r29_t) == 4, "Punned Structure Size");

// Register 0x2A [AMBA:0xA00000A8]
typedef union prev18_r2A{
  struct{
...
#define PREv18_R2A_DEFAULT {{0x0000, 0x00}}
_Static_assert(sizeof(prev18_r2A_t) == 4, "Punned Structure Size");

// Register 0x2B [AMBA:0xA00000AC]
typedef union prev18_r2B{
  struct{
...
#define PREv18_R2B_DEFAULT {{0x007FF, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(prev18_r2B_t) == 4, "Punned Structure Size");

// Register 0x2C [AMBA:0xA00000B0]
typedef union prev18_r2C{
  struct{
    unsigned STR_WR_CH1_BUF_OFF		: 20;
  };
  uint32_t as_int;
} prev18_r2C_t;
#define PREv18_R2C_DEFAULT {{0x00000}}
_Static_assert(sizeof(prev18_r2C_t) == 4, "Punned Structure Size");

// Register 0x2D [AMBA:0xA00000B4]
typedef union prev18_r2D{
  struct{
...
#define PREv18_R2D_DEFAULT {{0x0000, 0x00}}
_Static_assert(sizeof(prev18_r2D_t) == 4, "Punned Structure Size");

// Register 0x2E [AMBA:0xA00000B8]
typedef union prev18_r2E{
  struct{
...
#define PREv18_R2E_DEFAULT {{0x0000, 0x00}}
_Static_assert(sizeof(prev18_r2E_t) == 4, "Punned Structure Size");

// Register 0x2F [AMBA:0xA00000BC]
typedef union prev18_r2F{
  struct{
...
#define PREv18_R2F_DEFAULT {{0x007FF, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(prev18_r2F_t) == 4, "Punned Structure Size");

// Register 0x30 [AMBA:0xA00000C0]
typedef union prev18_r30{
  struct{
    unsigned STR_WR_CH0_BUF_OFF		: 20;
  };
  uint32_t as_int;
} prev18_r30_t;
#define PREv18_R30_DEFAULT {{0x00000}}
_Static_assert(sizeof(prev18_r30_t) == 4, "Punned Structure Size");
...
#define PREv18_R33_DEFAULT {{0x00000, 0x0, 0x0, 0x0, 0x1}}
_Static_assert(sizeof(prev18_r33_t) == 4, "Punned Structure Size");
...
typedef union prev18_r3F{
  struct{
    unsigned CHIP_ID		: 24;
  };
  uint32_t as_int;
} prev18_r3F_t;
#define PREv18_R3F_DEFAULT {{0x000000}}
_Static_assert(sizeof(prev18_r3F_t) == 4, "Punned Structure Size");

// Register 0x40 [AMBA:0xA0000100]
typedef union prev18_r40{
  struct{
...
#define PREv18_R40_DEFAULT {{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}
_Static_assert(sizeof(prev18_r40_t) == 4, "Punned Structure Size");
